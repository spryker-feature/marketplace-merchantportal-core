...
- [DashboardMerchantPortalGui ^4.0.0](https://github.com/spryker/dashboard-merchant-portal-gui) (MP GUI)
...
- [SecurityMerchantPortalGuiExtension ^1.3.0](https://github.com/spryker/security-merchant-portal-gui-extension) (Extension)
